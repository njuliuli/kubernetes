...
readonly KUBE_DOCKER_REGISTRY="${KUBE_DOCKER_REGISTRY:-gcr.io/google-containers}"
readonly KUBE_BASE_IMAGE_REGISTRY="${KUBE_BASE_IMAGE_REGISTRY:-gcr.io/google-containers}"
